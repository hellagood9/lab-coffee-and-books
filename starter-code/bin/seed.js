...
const restaurantsToSave = restaurants.map(restaurant => ({ name: restaurant.name, type: restaurant.cuisine_type, location: { type: 'Point', coordinates: [restaurant.latlng.lng, restaurant.latlng.lat] } }));

Place.create(restaurantsToSave)
